...
*This library is deprecated; you should use the newer Pololu "Zumo Shield Arduino library":https://github.com/pololu/zumo-shield-arduino-library instead, which is easier to install and use.*
